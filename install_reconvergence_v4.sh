...
cat > reflection_reconcile_v4.py <<'PY'
#!/usr/bin/env python3
"""
...
python3 -m py_compile reflection_reconcile_v4.py

echo
echo "=== RUNNING V4 DETERMINISTIC REPLAY ==="
python3 reflection_reconcile_v4.py

echo
echo "=== RECONVERGENCE AFTER V4 REPLAY ==="
python3 reconvergence.py

echo
echo "=== V4 AUDIT SUMMARY ==="
...
echo "V4 reconciles liquidity_usd <- initial_liquidity_usd"
echo "without changing the historical value."
echo "No synthetic cases."
echo "No outcome leakage."
echo "No random data."
