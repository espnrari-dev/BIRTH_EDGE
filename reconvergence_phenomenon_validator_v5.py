...
"""
BIRTH_EDGE — RECONVERGENCE PHENOMENON VALIDATOR V5

CLOSED-LOOP TEMPORAL EPISODE ENGINE

Purpose
-------
Measure naturally occurring historical reconvergence:
...
Rules
-----
1. ONLY persisted historical BIRTH_EDGE records are used.
2. No synthetic data.
3. No historical-data modification.
4. No model modification.
5. No trading.
6. A divergent record following convergence opens an episode.
7. Consecutive divergent records extend the same episode.
8. A later FULL_CONVERGENCE closes the episode.
9. Divergence without preceding convergence is ignored.
10. No recovery is inferred.
"""
...
def collect_episodes(rows):
    """
    CLOSED-LOOP TEMPORAL STATE MACHINE

    C + D => OPEN
    D + D => EXTEND
    D + C => CLOSE

    Divergence without a preceding C is ignored.
    """
    ...
    for row in rows:
        ...
        if active is None:
            ...
            if divergent:
                ...
                # We only open when the immediately preceding
                # historical case was FULL_CONVERGENCE.
                if (
                    previous is not None
                    and previous["three_way"] == 1
                ):
...
def main():
    ...
    result = {
        ...
        "engine":
            "BIRTH_EDGE_RECONVERGENCE_PHENOMENON_VALIDATOR_V5",
    ...
    print()
    print("=" * 76)
    print("TEMPORAL STATE TRANSITIONS")
    print("=" * 76)
    ...
    print("IMMEDIATE:", len(immediate_recoveries))
    print("NON-ADJACENT:", len(nonadjacent_recoveries))
    print("FULL PATH RECOVERY:", len(full_recoveries))
    ...
    print()
    print("=" * 76)
    print("RECONVERGENCE VALIDATOR V5 COMPLETE")
    print("=" * 76)
