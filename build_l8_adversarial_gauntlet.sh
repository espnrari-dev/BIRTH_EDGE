...
BACKUP="$ROOT/backups/L8_ADVERSARIAL_$STAMP"
EVIDENCE="$ROOT/logs/evidence/level8/L8_ADVERSARIAL_$STAMP"

mkdir -p "$BACKUP" "$EVIDENCE"

echo "=============================================================="
echo "BIRTH_EDGE — L8 ADVERSARIAL DISCOVERY GAUNTLET"
echo "=============================================================="
echo "STAMP    : $STAMP"
...
cat > "$ROOT/l8_adversarial_gauntlet.py" <<'PY'
#!/usr/bin/env python3
...
chmod +x "$ROOT/l8_adversarial_gauntlet.py"
...
echo "Auditor        : YES"
echo "Evidence       : logs/evidence/level8/"
echo
echo "RUNNING L8..."
echo
...
python -u l8_adversarial_gauntlet.py \
    | tee "$EVIDENCE/L8_CONSOLE.log"

STATUS=${PIPESTATUS[0]}

echo
echo "=============================================================="
echo "L8 EXIT STATUS: $STATUS"
echo "=============================================================="
